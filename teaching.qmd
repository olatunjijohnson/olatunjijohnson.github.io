...
- **Advanced Geostatistical Modelling** (FUTA, Nigeria, 2026) — a three-day workshop
  on spatial and spatio-temporal analysis, multivariate modelling, non-stationary
  processes, and machine learning for geostatistics. Supported by the **London
  Mathematical Society (Scheme 5)** and the Department of Mathematics, University of
  Manchester. [Workshop materials](https://olatunjijohnson.github.io/FUTA-workshop-2026/){.btn .btn-primary .btn-sm}
...
I build interactive R/Shiny tools for teaching spatial statistics, including
**MBGapp** (model-based geostatistics) and **variogramApp** (exploring variograms
and Gaussian random fields). See the [Software](software.qmd) page for the full list
with live demos.
